# Generated by Django 4.2.8 on 2025-05-31 03:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "limite_wip",
                    models.IntegerField(
                        default=0, help_text="Work In Progress - 0 = sem limite"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "membros",
                    models.ManyToManyField(
                        related_name="projetos_membro", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="usuario",
            index=models.Index(fields=["empresa"], name="usuario_empresa_ee9697_idx"),
        ),
        migrations.AddIndex(
            model_name="usuario",
            index=models.Index(
                fields=["empresa", "tipo"], name="usuario_empresa_bc7d7d_idx"
            ),
        ),
    ]
